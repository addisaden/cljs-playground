...
goog.provide("webapp.main");
goog.require("cljs.core");
webapp.main.my_element = jQuery.parseHTML("\x3cdiv\x3e\x3c/div\x3e");
jQuery(document).ready(function() {
  return jQuery("body").append(webapp.main.my_element);
});
webapp.main.my_header = jQuery.parseHTML("\x3ch1\x3e\x3c/h1\x3e");
jQuery(webapp.main.my_element).append(webapp.main.my_header);
jQuery(webapp.main.my_header).text("!! Hallo Clojure-Script !!");
webapp.main.my_link = jQuery.parseHTML('\x3ca href\x3d"#"\x3e\x3c/a\x3e');
jQuery(webapp.main.my_element).append(webapp.main.my_link);
jQuery(webapp.main.my_link).text("Ein Link");
webapp.main.ticker = cljs.core.atom.call(null, 0);
webapp.main.jquery_get_position = function jquery_get_position(selector) {
  var p = jQuery(selector).position();
  return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "top", "top", -1856271961), p.top, new cljs.core.Keyword(null, "left", "left", -399115937), p.left], null);
};
webapp.main.my_link_on_click = function my_link_on_click() {
  cljs.core.swap_BANG_.call(null, webapp.main.ticker, cljs.core.inc);
  alert([cljs.core.str("Der Ticker ist auf "), cljs.core.str(cljs.core.deref.call(null, webapp.main.ticker)), cljs.core.str(" "), cljs.core.str("Und die Position top ist "), cljs.core.str(function() {
    var p = webapp.main.jquery_get_position.call(null, webapp.main.my_link);
    return[cljs.core.str("top: "), cljs.core.str((new cljs.core.Keyword(null, "top", "top", -1856271961)).cljs$core$IFn$_invoke$arity$1(p)), cljs.core.str(" "), cljs.core.str("left: "), cljs.core.str((new cljs.core.Keyword(null, "left", "left", -399115937)).cljs$core$IFn$_invoke$arity$1(p))].join("");
  }())].join(""));
  return false;
};
jQuery(webapp.main.my_link).click(webapp.main.my_link_on_click);
